...
<head>
    ...
    <style>
        body {
            background-image: url("https://cdn.hipwallpaper.com/i/68/92/dTer6z.jpg");
...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <center><h4 style="border: 5px solid white; border-radius: 15px; background: white; color: black; padding: 10px;font-size: 18px">Membership</h4></center>
