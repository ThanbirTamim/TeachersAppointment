...
class CreateThesisProjectStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('thesis_project_students', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('thesis_project_students');
    }
}
